...
from research.regime.backtest_regime_assets import fetch, regime_series, simulate, _cagr, _ulcer, GOLD_CURRENT, COST_BPS
from research.regime.ma_trend_strategies import bootstrap_vs_bh
