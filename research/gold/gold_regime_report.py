...
from research.gold.gold_regime_data import load_or_build, fetch_all
from research.gold.gold_regime_signal import (
...
import research.gold.gold_regime_overfit_gate as OG
...
def self_test():
    from research.gold.gold_regime_signal import _mk_row  # 재사용 — 합성 row
